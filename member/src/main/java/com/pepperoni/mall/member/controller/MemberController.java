package com.pepperoni.mall.member.controller;

import java.util.Arrays;
import java.util.Map;

//import org.apache.shiro.authz.annotation.RequiresPermissions;
import com.pepperoni.mall.member.feign.CouponFeignService;
...
public class MemberController {
    ...
    public R test() {
        ...
        R ret = couponFeignService.member_coupon();
        return R.ok().put("member",memberEntity).put("coupon",ret.get("coupons"));
    }
